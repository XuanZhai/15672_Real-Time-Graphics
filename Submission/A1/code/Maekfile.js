...
if (maek.OS === 'linux') {
	...
	maek.options.LINKLibs = [ 
		...
		'vulkan-1.lib',
		`/LIBPATH:${VULKAN_SDK}/../glfw-3.3.9.bin.WIN64/lib-vc2017`,	// NOTE: Change this to your GLFW lib directory.
		'glfw3dll.lib'
	];
	maek.options.CPPFlags = [
		`/I${VULKAN_SDK}/Include`,
		`/I${VULKAN_SDK}/../glfw-3.3.9.bin.WIN64/include`,	// NOTE: Change this to your GLFW include directory.
		'/O2'
	];
...
const viewer_objs = [
	maek.CPP('main.cpp'),
	maek.CPP('EventHelper.cpp'),
	maek.CPP('FrustumCulling.cpp'),
	maek.CPP('RenderHelper.cpp'),
	maek.CPP('S72Helper.cpp'),
	maek.CPP('VulkanHelper.cpp'),
	maek.CPP('XZJParser.cpp'),
	maek.CPP('XZMath.cpp'),
];
...
maek.GLSLC = (glslFile, spirvFileBase, localOptions = {}) => {
	...
	const command = [...glslc, glslFile, '-o', spirvFile];
...
const viewer_exe = maek.LINK([...viewer_objs], 'bin/viewer');
