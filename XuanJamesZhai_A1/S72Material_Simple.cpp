 ...
 */
void S72Object::Material_Simple::CreateDescriptorSetLayout(const VkDevice& device){
 ...
 */
void S72Object::Material_Simple::CreateDescriptorSets(const VkDevice& device,VkSampler const &textureSampler){
